...
from . import ImageFolder_custom, CelebA_custom, FEMNIST
...
def load_data(datadir, dataset, p_train=1.0, p_test=1.0):
    ...
    if dataset == 'mnist':
        dataobj_train = DatasetZoo(datadir, dataset='mnist', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='mnist', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'usps':
        dataobj_train = DatasetZoo(datadir, dataset='usps', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='usps', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'fmnist':
        dataobj_train = DatasetZoo(datadir, dataset='fmnist', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='fmnist', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'cifar10':
        dataobj_train = DatasetZoo(datadir, dataset='cifar10', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='cifar10', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'cifar100':
        dataobj_train = DatasetZoo(datadir, dataset='cifar100', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='cifar100', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'svhn':
        dataobj_train = DatasetZoo(datadir, dataset='svhn', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='svhn', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'stl10':
        dataobj_train = DatasetZoo(datadir, dataset='stl10', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='stl10', train=False, transform=transform, download=True,
                                  p_data=p_test)
    elif dataset == 'celeba':
        dataobj_train = DatasetZoo(datadir, dataset='celeba', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='celeba', train=False, transform=transform, download=True,
                                  p_data=p_test)
        ...
        dataobj_train = DatasetZoo(datadir, dataset='femnist', train=True, transform=transform, download=True,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='femnist', train=False, transform=transform, download=True,
                                  p_data=p_test)
        # return X_train, y_train, u_train, X_test, y_test, u_test = load_femnist_data(datadir)
    elif dataset == 'cinic10':
        dataobj_train = DatasetZoo(datadir, dataset='cinic10', train=True, transform=transform, download=False,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='cinic10', train=False, transform=transform, download=False,
                                  p_data=p_test)
    elif dataset == 'ham10000':
        dataobj_train = DatasetZoo(datadir, dataset='ham10000', train=True, transform=transform, download=False,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='ham10000', train=False, transform=transform, download=False,
                                  p_data=p_test)
    elif dataset == 'medmnist':
        dataobj_train = DatasetZoo(datadir, dataset='medmnist', train=True, transform=transform, download=False,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='medmnist', train=False, transform=transform, download=False,
                                  p_data=p_test)
    elif dataset == 'covid19':
        dataobj_train = DatasetZoo(datadir, dataset='covid19', train=True, transform=transform, download=False,
                                   p_data=p_train)
        dataobj_test = DatasetZoo(datadir, dataset='covid19', train=False, transform=transform, download=False,
                                  p_data=p_test)
...
def partition_data(dataset, datadir, partition, num_users, niid_beta=0.5, iid_beta=0.5, p_train=1.0, p_test=1.0):
    ...
    dataset_stats = {'mnist': {'ntrain': 60000, 'ntest': 10000, 'nclasses': 10},
                     ...
                     # 'cinic': {'ntrain': 50000, 'ntest': 10000, 'classes': 10},
                     ...
                     'ham10000': {'ntrain': 9000, 'ntest': 1000, 'classes': 7}
                     }
