...
def args_parser_fedavg():
    ...
    parser.add_argument('--niid_beta', type=float, default=1, help='The parameter for non-iid data partitioning')
    parser.add_argument('--iid_beta', type=float, default=0.1, help='The parameter for iid data partitioning')
